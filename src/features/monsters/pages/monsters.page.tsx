...
export const MonstersPage = () => {
  ...
  const tableOfContentsNav = {
    to: '/monsters',
    part: t('monster:bookOfMonsters'),
    text: t('monster:bookOfMonsters'),
  }

  const randomMonsterNav = {
    to: '/monsters/random',
    part: t('monster:randomMonster.title'),
    text: t('monster:randomMonster.title'),
  }
  ...
  const communityMonstersNav = communityMonsters.map((m) => ({
    ...
    part: t('monster:communityMonster.title'),
    text: t(m.name),
  }))
  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col gap-8">
        ...
        <section>
          <Typography variant="h3" parchment>
            {t(`monster:communityMonster.title`)}
          </Typography>
          <div className="mb-4">
            {t('monster:communityMonster.description')}
          </div>
          <BookList>

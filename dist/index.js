...
var DayCounter = () => {
  ...
  const spendQuarter = () => {
    ...
    const qs = [...range(spent).map((_2) => true), ...range(4 - spent).map((_2) => false)];
    setQuarters(qs);
  };
  return jsx("button", {
    css: {
...
var CalendarPage = () => {
  ...
  return jsx("div", {
    ...
    css: {}
  }, jsx(parchment_default, null, jsx("div", {
    css: {
      textAlign: "center",
      fontSize: "1.25rem",
      lineHeight: "1.75rem",
    ...
    className: "yx-prose"
  }, "År ", cal.year, " E.S. (Efter skiftet)"), months.map((m3) => jsx("div", {
    css: {
      marginBottom: "1rem"
    },
    key: m3.name
    ...
    key: i2
  }, getDayName(i2))), range(getDayNumber(m3.days[0].name) - 1).map((i2) => jsx("div", {
    css: {
      borderWidth: "1px",
      padding: "0.5rem",
      display: "flex",
  ...
  }, d3.number), jsx("div", null, getMoonEmoji(d3.moon)), jsx("div", null, getWeatherIcon(d3))), jsx("div", null, jsx(day_counter_default, null))), jsx("div", null, jsx("div", null, "Högt: ", getTempString(d3.temp)), jsx("div", null, "Lågt: ", getTempString(d3.lowTemp)), jsx("div", null, d3.downpour), jsx("div", null, d3.stormType), jsx("div", null, d3.stormType), jsx("div", null, d3.eventType?.name))))))))));
};
